...
<div class="row fullWidth" style="margin-top: 20px">
    ...
    <ul class="pagination">
        ...
        {
          echo '<li class="arrow"><a href="mare.php?page='.($_SESSION['page_no']-1).'">&laquo;</a></li>';
        }
        for($page=1; $page<=$_SESSION['pages']; $page++)
        {
            if($page==$_SESSION['page_no'])
            {
                echo '<li class="current"><a href="mare.php?page='.$page.'">'.$page.'</a></li>';
            }
            else
            {
                echo '<li><a href="mare.php?page='.$page.'">'.$page.'</a></li>';
            }
        }
        ...
        {
            echo '<li class="arrow"><a href="mare.php?page='.($_SESSION['page_no']+1).'">&raquo</a></li>
    </ul>
    </div>';
        }
echo'
...
for($x=0; $x<20; $x++)
{
    echo'<tr>
            ...
            <td class="small-2 columns"><a href="indiv_horse.php"><img src="./images/demo-mare.jpg" style="height: 100px;"></a></td>
